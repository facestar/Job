...
<div align="center">
	...
	<!-- 关注在这里 -->							<div style="width: 80px;height: 30px;border: 1px solid;
										text-align: center;padding-top: 3px;margin-left: 450px;
										margin-top: -15px;background-color: red;color: white;padding-top:5px;
										font-weight: bold;" class="g1"
										onclick="window.location.href='/job/guanzhu/addgz2.do?uname=${login.uname}&cid=${pp.id}&wid=${cc.id }'">${gz}</div>
							</div>
							<div style="margin-top: -20px;"> 公司网址：<a href="http://www.mengniu.com.cn/">${pp.web_url }</a></div>
				...
				<div style="clear:both;">
					<div style="float:left; width:65%; min-height:100px;">
						...
						<div class="" style="border:#CCCCCC 1px dashed;" >
							...
							<div style="margin-top:5px;">兼职类型：如图所示<div><img title="${cc.wtitle}" src="imagezqy/${cc.wtype }.jpg" /></div></div>
						...
						<div>
							...
							<div>
								<div style="width:97%; height:auto !important; min-height:150px; overflow: border:#999999 1px solid; height:150px; padding:8px; text-align:left;">
											<div style="width: 400px;height: 300px;" class="nei">
												<div style="font-weight: bold;font-size: 13px;">评论内容：</div>
												&nbsp;&nbsp;<form name="dd" action="/job/guanzhu/addpinl.do?uid=${login.id }&wid=${cc.id}&cid=${pp.id}" method="post">
												<textarea id="nr" class="pinglun" name="content" style="width: 320px;height: 230px;"></textarea>
												<br>
												<h5>给兼职评分:</h5>
												
													5分<input type="radio" checked="checked"  id="jifen" name="jifen" value="5">
													 4分<input type="radio" id="jifen"
														name="jifen" value="4">
														 3分<input id="jifen"
														type="radio" name="jifen" value="3">
													2分<input type="radio" name="jifen" id="jifen"
														value="2">
														 1分<input type="radio" id="jifen"
														name="jifen" value="1"><br>
														 <input
														type="submit" value="提交" onclick="sha()" class="tijiao" style="margin-left: 100px;margin-top:10px;width: 58px; height: 28px;" />
												</form>
											</div>
										</div>
							</div>
